...
public partial class AppDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Auditlog>(entity =>
        {
            ...
            entity.Property(e => e.InsertedDate).HasDefaultValueSql("CURRENT_TIMESTAMP").HasColumnType("datetime").HasColumnName("inserted_date");
        ...
        modelBuilder.Entity<Contactperson>(entity =>
        {
            ...
            entity.Property(e => e.InsertedBy).HasMaxLength(50).HasColumnName("inserted_by");
            entity.Property(e => e.InsertedDate).HasColumnType("datetime").HasColumnName("inserted_date");
            entity.Property(e => e.IsActive).HasDefaultValue(true).HasColumnName("is_active");
            ...
            entity.HasOne(d => d.Company).WithMany(p => p.Contactpeople).HasForeignKey(d => d.CompanyId).HasConstraintName("contactpersons_ibfk_1");
            entity.HasOne(d => d.Department).WithMany(p => p.Contactpeople).HasForeignKey(d => d.DepartmentId).HasConstraintName("ck_contactp_department");
            entity.HasOne(d => d.Organisation).WithMany(p => p.Contactpeople).HasForeignKey(d => d.OrganisationId).HasConstraintName("contactpersons_ibfk_2");
        });
        ...
        modelBuilder.Entity<Department>(entity =>
        {
            ...
            entity.HasOne(d => d.Organisation).WithMany(p => p.Departments).HasForeignKey(d => d.OrganisationId).HasConstraintName("departments_ibfk_1");
        });
        ...
        modelBuilder.Entity<Employee>(entity =>
        {
            ...
            entity.HasOne(d => d.Designation).WithMany(p => p.Employees).HasForeignKey(d => d.DesignationId).HasConstraintName("fk_employees_designation");
            entity.HasOne(d => d.Location).WithMany(p => p.Employees).HasForeignKey(d => d.LocationId).HasConstraintName("ck_employee_location");
            entity.HasOne(d => d.ReportingManager).WithMany(p => p.InverseReportingManager).HasForeignKey(d => d.ReportingManagerId).HasConstraintName("employees_ibfk_2");
            entity.HasOne(d => d.User).WithMany(p => p.Employees).HasForeignKey(d => d.UserId).HasConstraintName("employees_ibfk_1");
        });
        ...
        modelBuilder.Entity<ExpenseApproval>(entity =>
        {
            ...
            entity.HasOne(d => d.Visit).WithMany(p => p.ExpenseApprovals).HasForeignKey(d => d.VisitId).HasConstraintName("expenseapprovals_ibfk_1");
        });
        ...
        modelBuilder.Entity<Expenserate>(entity =>
        {
            ...
            entity.HasOne(d => d.VehicleType).WithMany(p => p.Expenserates).HasForeignKey(d => d.VehicleTypeId).HasConstraintName("expenserates_ibfk_1");
        });
        ...
        modelBuilder.Entity<MstDesignation>(entity =>
        {
            ...
            entity.HasOne(d => d.Department).WithMany(p => p.DesignationName).HasForeignKey(d => d.DepartmentId).HasConstraintName("fk_designation_department");
        });
        ...
        modelBuilder.Entity<Organisation>(entity =>
        {
            ...
            entity.HasOne(d => d.Company).WithMany().HasForeignKey(d => d.CompanyId).HasConstraintName("organisations_ibfk_1");
        });
        ...
        modelBuilder.Entity<User>(entity =>
        {
            ...
            entity.Property(e => e.InsertedDate).HasDefaultValueSql("CURRENT_TIMESTAMP").HasColumnType("datetime").HasColumnName("inserted_date");
            entity.Property(e => e.IsActive).HasDefaultValue(true).HasColumnName("is_active");
            entity.Property(e => e.IsFirstLogin).IsRequired().HasDefaultValueSql("'1'");
            entity.Property(e => e.Mobile).HasMaxLength(20);
        ...
        modelBuilder.Entity<Visit>(entity =>
        {
            ...
            entity.Property(e => e.InsertedBy).HasMaxLength(50).HasColumnName("inserted_by");
            entity.Property(e => e.InsertedDate).HasDefaultValueSql("CURRENT_TIMESTAMP").HasColumnType("datetime").HasColumnName("inserted_date");
            entity.Property(e => e.IsActive).HasDefaultValueSql("'1'").HasColumnName("is_active");
            ...
            entity.HasOne<Visitpurpose>().WithMany().HasForeignKey(d => d.VisitPurposeId).HasConstraintName("visits_ibfk_6");
            entity.HasOne<Vehicletype>().WithMany().HasForeignKey(d => d.VehicleTypeId).HasConstraintName("visits_ibfk_7");
            entity.HasOne<Funnelstage>().WithMany().HasForeignKey(d => d.FunnelStageId).HasConstraintName("visits_ibfk_8");
            entity.HasOne<Outcometype>().WithMany().HasForeignKey(d => d.OutcomeTypeId).HasConstraintName("visits_ibfk_9");
        });
        ...
        modelBuilder.Entity<VisitApprovalHistory>(entity =>
        {
            ...
            entity.Property(e => e.PreviousStatus).HasMaxLength(50).HasColumnName("previous_status");
            entity.Property(e => e.IpAddress).HasMaxLength(50).HasColumnName("ip_address");
            entity.Property(e => e.Remark).HasMaxLength(500).HasColumnName("remark");
            entity.Property(e => e.UpdatedBy).HasMaxLength(50).HasColumnName("updated_by");
            entity.Property(e => e.UpdatedDate).ValueGeneratedOnAddOrUpdate().HasColumnType("datetime").HasColumnName("updated_date");

            entity.HasOne(e => e.Visit).WithMany().HasForeignKey(e => e.VisitId).HasConstraintName("visit_approval_histories_ibfk_1");
        });
        ...
        modelBuilder.Entity<Visitattachment>(entity =>
        {
            ...
            entity.HasOne(d => d.Visit).WithMany(p => p.Visitattachments).HasForeignKey(d => d.VisitId).HasConstraintName("visitattachments_ibfk_1");
        });
        ...
        modelBuilder.Entity<Visitfollowup>(entity =>
        {
            ...
            entity.HasOne(d => d.Visit).WithMany(p => p.Visitfollowups).HasForeignKey(d => d.VisitId).HasConstraintName("visitfollowups_ibfk_1");
        });
